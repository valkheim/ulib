...
TEST(modules, test_modules_with_ntquerysysteminformation)
{
  auto i = 0;
...
TEST(modules, test_modules_with_enumerateloadedmoduels)
{
  auto i = 0;
  ::ul::walk_modules_using_enumerateloadedmodules([&i](::ul::Module const *module) -> ::ul::walk_t {
    i++;
    // ::ul::show_module(module);
    return ::ul::walk_t::WALK_CONTINUE;
  });
